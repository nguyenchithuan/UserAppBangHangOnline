...
public abstract class PaginationScrollListienner extends RecyclerView.OnScrollListener {
    private GridLayoutManager gridLayoutManager;

    public PaginationScrollListienner(GridLayoutManager gridLayoutManager) {
